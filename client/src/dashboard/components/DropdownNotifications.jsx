  ...
  return (
    <div className="relative inline-flex">
      ...
      >
        ...
        >
          <div className="text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase pt-1.5 pb-2 px-4">Notificaciobes</div>
          <ul>
            <li className="border-b border-slate-200 dark:border-slate-700 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">📣 <span className="font-medium text-slate-800 dark:text-slate-100">Edite su información en un momento</span> Sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim.</span>
