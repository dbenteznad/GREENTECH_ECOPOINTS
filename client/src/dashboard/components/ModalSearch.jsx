        ...
        >
          ...
          <div className="py-4 px-2">
            ...
            <div className="mb-3 last:mb-0">
              <div className="text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase px-2 mb-2">Búsquedas recientes</div>
            ...
            {/* Recent pages */}
            <div className="mb-3 last:mb-0">
              <div className="text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase px-2 mb-2">Páginas recientes</div>
              <ul className="text-sm">
                <li>
                  <Link
                    className="flex items-center p-2 text-slate-800 dark:text-slate-100 hover:text-white hover:bg-indigo-500 rounded group"
                  ...
                  >
                    ...
                    <span>
                      ...
                      <span className="text-slate-600 dark:text-slate-400 group-hover:text-white">Conversación / … / Asistencia técnica</span>
                    </span>
                  </Link>
                </li>
              </ul>
