        ...
        <>
            ...
            <div className=" container mx-auto grid md:grid-cols-3">
                ...
                <div className="py-5  col-span-1 rounded-lg hover:scale-110   mr-4 mb-6 font-mono " >
                    ...
                    <h1 className="text-center text-lg mb-2  "><b>Premio 4</b></h1>
                ...
                {/* premio5 */}
                <div className=" py-5 col-span-1 rounded-lg hover:scale-110  mr-4 mb-6 font-mono" >
                    <h1 className="text-center text-lg mb-2 " ><b>Premio 5</b></h1>
                ...
                <div className="py-5 col-span-1 rounded-lg  hover:scale-110  mr-4 mb-6 font-mono " >
                    ...
                    <h1 className="text-center text-lg mb-2 "><b>Premio 6</b></h1>
