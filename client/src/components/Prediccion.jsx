...
function Prediccion () {
      ...
      return (
        <div className="contain">
          ...
          <p>
            <u>Cómo funciona la predicción:</u> Debes el número correspondiente de la palabra, en las celdas blancas.
          </p>
          ...
          {/* Mostrar los resultados y el mensaje adicional solo si hay resultados */}
      {results.cant_aluminio && (
        <>
          ...
          <div className="results">
            ...
            <p>
              Peso de papel: <span>{results.kg_papel} kg.</span>
            </p>
            <p>
              Peso de orgánico: <span>{results.kg_organico} kg.</span>
            </p>
          </div>
          {/* Mostrar mensaje adicional solo si es relevante */}
          {results.mensaje_adicional && <p>{results.mensaje_adicional}</p>}
        </>
      )}
    </div>
  );
