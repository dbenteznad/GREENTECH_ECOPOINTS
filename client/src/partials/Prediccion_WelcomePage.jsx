...
const linkedInProfileUrlDaniBenitez = 'https://www.linkedin.com/in/danicf/';
  ...
  function Prediccion() {
    ...
    const mensajeAdicionalRef = useRef(null);
    ...
    useEffect(() => {
      if (resultsReady && Object.keys(userInputs).length > 0) {
        ...
        setShowMessage(true);
        setTimeout(() => {
          if (mensajeAdicionalRef.current && footerRef.current) {
            const topPosition = mensajeAdicionalRef.current.offsetTop;
            const footerPosition = footerRef.current.offsetTop;
            const windowHeight = window.innerHeight;
            const offset = 20; // Ajusta este valor según tus preferencias
  
            if (topPosition + windowHeight + offset < footerPosition) {
              window.scrollTo({ top: topPosition, behavior: 'smooth' });
            } else {
              window.scrollTo({ top: footerPosition - windowHeight - offset, behavior: 'smooth' });
            }
          }
        }, 100);
      }
    ...
    return (
      <>
        ...
        <div className="bloque">
          ...
          <div className="contenedor-principal" >
            ...
            {showResults && showMessage && (
              <div className="mensaje-adicional" ref={mensajeAdicionalRef}>
                <p>
        ...
        {/* Footer */}
        <Chat />
        <footer className="bg-green-500" ref={footerRef}>
