...
const chartRef = useRef(null);
  ...
  return (
    <div className='grid md:grid-cols-2'>
       ...
       <h1 className='span-col-1 items-center text-center mx-auto'>Ahora bien, en Cataluña, la historia es aún más inspiradora. 
       ...
       Y en los últimos datos, se situarían en un encomiable 46% para Cataluña y un 41% para España.</h1>
