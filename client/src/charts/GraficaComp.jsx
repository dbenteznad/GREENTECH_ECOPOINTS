    ...
    return (
        ...
        <div className=' container grid md:grid-cols-2'>
            ...
            <div className=' span-col-1 relative z-0 mb-5 mr-5'>
                <div className=' w-1/2 relative sm:w-1/3 ' id="comparativa"></div>
                
            </div>
            <div className="span-col-1  items-center text-center relative">
            <p className='mt-44 mr-4 items-center text-right '>Pero, ¿qué nos depara el futuro? La UE ha establecido objetivos ambiciosos para el reciclaje, y es 
