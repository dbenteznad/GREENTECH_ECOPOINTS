...
class Chat:
    def __init__(self,ventana):
        ...
        self.bot = RiveScript()
        self.bot.load_file('data-science\Chatbot\Python\datoschat.rive')
        self.bot.sort_replies()
        #Inicializamos la ventana de tipo GUI
        self.ventana=ventana
        self.ventana.title("Quimi ChatBot")
        #Creamos un marco que contendra los diferentes elementos
        marco=LabelFrame(self.ventana,text="Quimi")
    ...
    def preguntar(self,event=None):
        ...
        self.entRespuesta.insert(END,"Quimi: "+reply+"\n")
