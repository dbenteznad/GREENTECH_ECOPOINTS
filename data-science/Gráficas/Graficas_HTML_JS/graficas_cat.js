...
var data = {
    ...
    datasets: [
        ...
        },
        {
            ...
            backgroundColor: 'rgba(75, 192, 192, 0.2)',
            borderColor: 'rgba(75, 192, 192, 1)',
            data: [13.96, 16.85, 19.80, 22.64, 25.42, 29.11, 31.95, 33.60,
                34.41, 37.53, 40.54, 40.60, 39.10, 37.95, 38.19, 38.98,
        ...
        },
        {
            ...
            borderWidth: 1,
            type: 'bar',
            data: [2990154, 2979879, 2985052, 3050499, 3080497, 2975745, 2905295, 2855589,
        ...
        },
        {
            ...
            backgroundColor: 'rgba(255, 159, 64, 0.2)',
            borderColor: 'rgba(255, 159, 64, 1)',
            data: [86.04, 83.15, 80.20, 77.36, 74.58, 70.89, 68.05, 66.40,
                65.59, 62.47, 59.46, 59.40, 60.90, 62.05, 61.81, 61.02,
                61.39, 60.12, 58.23, 55.10, 54.09, 53.37],
            yAxisID: 'line-y-axis',
            type: 'line',
            hoverBorderColor: 'rgba(255, 159, 64, 2)',
            hoverBackgroundColor: 'rgba(255, 159, 64, 0.4)',
        ...
        },
        {
            label: 'Suma Total ',
            type: 'bar',
            data: [3.475225, 3.583554, 3.721843, 3.943039, 4.130589, 4.197916, 4.269435, 4.300509,
...
var myChart = new Chart(document.getElementById('cataluña'), config);